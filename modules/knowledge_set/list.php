<h3>จัดการคลังความรู้</h3>
<div id="search">
<div id="searchBox">
<form class="form-inline">
 <input type="text" class="form-control " id="exampleInputName2" placeholder="ค้นหา" style="width:350px;">
...
<div id="btnBox">
  <input type="button" title="เพิ่มคำถาม" value="เพิ่มคำถาม" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form'" class="btn btn-warning vtip" />
</div>

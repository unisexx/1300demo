...
10:20 น.</td>
  ...
  02-222-3333
    ...
    <div class="DeptSent">สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์จังหวัดนนทบุรี<br />
นางสุมาลี  ดลสุขวงศาวัฒน์ (นักสังคมสงเคราะห์ปฎิบัติการ)<br />
02-888-9899
    </div>
    
    <div class="DeptSent">โรงพยาบาลนนทเวช<br />
นางพรศรี  สุตเธียรกุล (จิตแพทย์)<br />
02-999-4441
    </div>
  </td>
...
<!-- This contains the hidden content for inline calls แผนและการช่วยเหลือ-->
        ...
        <label>ประสานความช่วยเหลือ</label>
         ...
         <input type="text" class="form-control" id="tags" style="width:350px;" placeholder="พิมพ์ชื่อหน่วยงาน (auto complete)">
         </span>
        ...
        <div class="form-group form-inline col-md-6">
        <label>ชื่อผู้รับผิดชอบ/ประสาน</label>
        <input type="text" class="form-control" id="exampleInputEmail2" style="width:350px;">
        </div>
